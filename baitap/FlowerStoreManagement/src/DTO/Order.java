...
public class Order {
    ...
    public Order(String orderId, Date orderDate, String orderCustomerName, ArrayList<OrderDetail> details) {
    ...
    public String toString(){
        ...
        return "OrderID: " + orderId + " - " +
                "Order Date: " + df.format(orderDate) + " - " + 
                "Customber: " + orderCustomerName + " - " + 
